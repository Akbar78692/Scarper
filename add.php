...
?>
    ...
    <div class="container ">
      <h1 class="display-4" align="center"><span style="color:white;">Add </span><span style="color:red;">User</span></h1>
    </div>
  </div>
                    ...
                    <div class="col-md-4 offset-md-4">
                        <div class="card">
                            <div class="card-header  text-center">
                                <span class="lg">Add User</span><br>
                            </div>
...
if(isset($_POST['email']) && isset($_POST['password']))
{
    ...
    if (mysqli_query($con, $sql)) {
        echo '<script type="text/javascript"> alert("Sucessfully User Added");</script>';
      } else {
